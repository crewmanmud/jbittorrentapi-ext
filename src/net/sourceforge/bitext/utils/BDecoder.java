...
package net.sourceforge.bitext.utils;

import java.io.*;
import java.nio.*;
import java.util.*;

import net.sourceforge.bitext.bittorrent.Constants;
...
public class BDecoder {
	...
	private void print(PrintWriter writer, Map map) {
		print(writer, map, "", false);
	}

	//private String Indent(boolean skip_indent)
