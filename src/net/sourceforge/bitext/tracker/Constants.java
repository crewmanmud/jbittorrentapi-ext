...
public class
     ...
     */
    public static void loadConfig(String config) throws FileNotFoundException {
        ...
        if (configFile.exists()) {
            ...
            throw new FileNotFoundException("Could not load specified configuration file: '" + config + "'.");
        }
    }
}
