...
public class ClientHttpRequest {
    ...
    private static void pipe(byte[] input, OutputStream out) throws IOException {
    ...
    public void setParameter(String name, String fileName, byte[] torrent) throws IOException {
    	boundary();
        writeName(name);
        write("; filename=\"");
        write(fileName);
        ...
        newline();
        write("Content-Type: ");
        writeln("application/x-bittorrent");
        newline();
        pipe(torrent, os);
        newline();
    }
